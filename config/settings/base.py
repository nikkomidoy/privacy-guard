...
# privacy_guard/
APPS_DIR = BASE_DIR / "privacy_guard"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "privacy_guard.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "privacy_guard.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "privacy_guard.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "privacy_guard.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "privacy_guard.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "privacy_guard.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Privacy Guard API",
    "DESCRIPTION": "Documentation of API endpoints of Privacy Guard",
    "VERSION": "1.0.0",
